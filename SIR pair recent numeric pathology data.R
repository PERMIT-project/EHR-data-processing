...
load("crea.rephf2testsd.Rdata") #primary table
load("sirdatahfonly.rda") #full table containing all patient data
...
sir.data$EntryDate<-ifelse(sir.data$EntryDate>20170801|sir.data$EntryDate<19000101,NA,sir.data$EntryDate) #Coerce date fields to date format if required
